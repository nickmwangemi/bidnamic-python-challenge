...
def run():
    ...
    # Campaign
    file = open('/home/nickmwangemi/Dev/bidnamic-python-challenge/scripts/campaigns.csv')
    records = csv.reader(file, delimiter=',')
    ...
    # SearchTerm
    file = open('/home/nickmwangemi/Dev/bidnamic-python-challenge/scripts/search_terms.csv')
    records = csv.reader(file, delimiter=',')
